	...
	<main>
		...
		<form:form action="save" nethod="post" commandName="alumno" cssClass="form-horizontal " style="margin-bottom: 50px;">
			...
			<div class="form-group row ">
				...
				<div class=""> 
					<form:errors path="nombre" cssClass="badge badge-danger"></form:errors>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="">
					<form:errors path="fNacimiento" placeholder="dd/MM/yyyy" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" cssClass="badge badge-pill badge-danger" />
				</div>
			</div>
